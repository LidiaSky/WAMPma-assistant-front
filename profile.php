...
<div class = "container-fluid" style = "padding-top:120px;">
    <section class = "container register_bgr" >
        <div class = "container-page" style = "padding-bottom:100px;">
            <div class = "col-md-12" >
                <h3 class ="dark-grey">Данные пользоватtля</h3>
                ...
                <div class="form-group col-lg-6">
                   ...
                   <h4>Поиск информации, мультиагениные системы,веб-технологии </h4>
